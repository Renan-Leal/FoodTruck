...
public class VendasCanceladasDTO {
	...
	public void imprimir() {
		...
		System.out.printf("\n%-20s  %-24s  %12s  %12s  %12s  ", this.getNome(),
				this.validarData(this.getDataCancelamento()), df.format(this.getSubtotal()),
				df.format(this.getTaxaEntrega()), df.format(this.getTotal()));
	}
